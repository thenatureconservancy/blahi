...
* A substantial amount of what was mapped as grassland historically is now mapped as other types such as shrubland or exotics
...
* Five of the top six ecosystems depicted in the chart are missing succession classes on the landscape today, e.g., the Central Mixedgrass Prairie is missing class C.
* Most ecosystems have some 'UN", or uncharacteristic native vegetation, i.e., combinations of height and cover that were not present on the landscape historically.  The Northwestern Great Plains-Black Hills Ponderosa Pine Woodland and Savanna for example has > 40% UN.
