...
* Prior to European colonization the [Northwestern Great Plains Mixedgrass Prairie](https://landfirereview.org/search.php?q=Northwestern%20Great%20Plains%20Mixedgrass%20Prairie&hPP=20&idx=lf_landfire_dev&p=0&is_v=1){target="blank"} BpS was most dominant at ~30% of the subregion.
* The top 10 BpSs covered roughly 90% of the landscape.
* BpSs ranged from prairies to shrublands to sub-alpine forests.
